                ...
                <div className="payment flex flex-col md:flex-row gap-3 w-[85%] md:w-[80%] ">
                    <div className="supporters md:w-1/2 bg-slate-900 rounded-lg text-lg p-10 order-2 ">
                        ...
                        <ul className='md:mx-5'>
                            ...
                            {payments.map((p,i)=> {
                            <li key={i} className='my-2'>{p.name} donated <span className='font-bold'>₹{p.amount}</span> with a message <span className='font-bold'>&quot;{p.message}&quot</span></li>
                          })}
                        </ul>
                    </div>
                    <div className=" md:w-1/2 bg-slate-900 rounded-lg text-lg p-10 order-1 md:order-2">
                        ...
                        <div className="flex gap-2 flex-col">
                            ...
                            <button onClick={() => pay(paymentform.amount*100)} type='button' className='text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center '>Pay</button>
                        </div>
